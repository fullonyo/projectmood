...
export function UniversalEffectsEditor({ profile, onClose }: EffectsEditorProps) {
    ...
    const backgrounds = [
        ...
        { id: 'mesh-gradient', name: t('editors.effects.backgrounds.mesh-gradient') },
        { id: 'metaballs', name: t('editors.effects.backgrounds.metaballs') },
        { id: 'hyperspeed', name: t('editors.effects.backgrounds.hyperspeed') },
        { id: 'rain', name: t('editors.effects.backgrounds.rain') },
        { id: 'rhythm', name: t('editors.effects.backgrounds.rhythm') },
