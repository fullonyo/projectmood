            ...
            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-300">
                {!imageUrl ? (
                    ...
                    <div className="space-y-10">
                        <div className="relative rounded-[2rem] overflow-hidden shadow-2xl group bg-zinc-100 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 flex justify-center items-center p-4">
                            <img
                                src={imageUrl}
                                alt="Preview"
                                className="w-full h-auto max-h-72 object-contain transition-transform duration-700 group-hover:scale-105"
                            />
                        </div>

                        <EditorSection title={t('editors.photo.caption') || "Legenda"}>
                            <Input
                                value={caption}
                                onChange={(e) => {
                                ...
                                placeholder={t('editors.photo.caption_placeholder') || "Digite algo marcante..."}
                        ...
                        <EditorSection title="Integração ao Ambiente" description="Faz o GIF reagir à cor do mural.">
                            <EditorSwitch
