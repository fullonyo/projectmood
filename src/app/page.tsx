          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
              <div className="space-y-4">
                <h4 className="text-[9px] font-black uppercase tracking-[0.3em] text-zinc-600">{t('landing.footer_col_platform')}</h4>
                <ul className="space-y-2 text-[10px] font-medium uppercase tracking-tight text-zinc-400">
                  <li><Link href="#" className="hover:text-white transition-colors">{t('landing.footer_link_studio')}</Link></li>
                  <li><Link href="#" className="hover:text-white transition-colors">{t('landing.footer_link_global_wall')}</Link></li>
                  <li><Link href="#" className="hover:text-white transition-colors">{t('landing.footer_link_marketplace')}</Link></li>
                </ul>
              </div>

              <div className="space-y-4">
                <h4 className="text-[9px] font-black uppercase tracking-[0.3em] text-zinc-600">{t('landing.footer_col_ecosystem')}</h4>
                <ul className="space-y-2 text-[10px] font-medium uppercase tracking-tight text-zinc-400">
                  <li><Link href="#" className="hover:text-white transition-colors">{t('landing.footer_link_manifesto')}</Link></li>
                  <li><Link href="#" className="hover:text-white transition-colors">{t('landing.footer_link_community')}</Link></li>
                  <li><Link href="#" className="hover:text-white transition-colors">{t('landing.footer_link_labs')}</Link></li>
                </ul>
              </div>

              <div className="space-y-4">
                <h4 className="text-[9px] font-black uppercase tracking-[0.3em] text-zinc-600">{t('landing.footer_col_support')}</h4>
                <ul className="space-y-2 text-[10px] font-medium uppercase tracking-tight text-zinc-400">
                  <li><Link href="#" className="hover:text-white transition-colors">{t('landing.footer_link_help')}</Link></li>
                  ...
                  <li><div className="flex items-center gap-2 text-emerald-500/60">
                    ...
                    <span className="text-[9px] uppercase font-black tracking-widest opacity-60">{t('landing.footer_status_online')}</span>
                  </div></li>
              ...
              <div className="space-y-4 text-right md:text-left">
                <h4 className="text-[9px] font-black uppercase tracking-[0.3em] text-zinc-600">{t('landing.footer_col_social')}</h4>
                <ul className="space-y-2 text-[10px] font-medium uppercase tracking-tight text-zinc-400">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/5 gap-6">
              <div className="flex flex-col md:flex-row items-center gap-6 text-[9px] font-black uppercase tracking-[0.1em] text-zinc-700">
                ...
                <div>© {new Date().getFullYear()} {t('landing.footer_rights')}</div>
