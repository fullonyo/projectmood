    ...
    <div className="min-h-screen flex flex-col bg-white text-black selection:bg-black selection:text-white overflow-hidden relative">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 md:px-12 space-y-12">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-2 opacity-20">
            ...
            <span className="text-[8px] font-mono uppercase tracking-widest">{t('landing.version_deployment')}</span>
          </div>
        </div>
        ...
        <div className="hidden sm:flex gap-6 md:gap-12 w-full max-w-5xl justify-center pt-12 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-700">
          ...
          <div className="flex flex-col items-start translate-y-8">
            <span className="text-[8px] font-mono mb-2 uppercase">{t('landing.audio')}</span>
            <div className="w-32 h-40 bg-zinc-950" />
          </div>
          <div className="flex flex-col items-start -translate-y-4">
            <span className="text-[8px] font-mono mb-2 uppercase">{t('landing.curation')}</span>
      ...
      <footer className="relative z-10 py-6 sm:py-8 px-6 sm:px-12 flex flex-col sm:flex-row justify-between items-center sm:items-end gap-2 border-t border-zinc-100 text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400">
        ...
        <div className="flex gap-8">
          ...
          <span className="opacity-20">{t('landing.terms')}</span>
        </div>
      </footer>
    </div>
  );
