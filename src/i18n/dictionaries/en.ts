...
export const en: Dictionary = {
    ...
    landing: {
        ...
        btn_create_studio: "Build my Haven",
        version_deployment: "Syncing reality...",
        visuals: "01 // SANCTUARY",
        audio: "02 // FEELING",
        curation: "03 // MEMORY",
        showcase: {
            structure_title: "01 // YOUR SAFE HAVEN",
    ...
    auth: {
        ...
        register: {
            ...
            identity_established: "Your haven has been prepared. Entering...",
            cancel: "Back",
    ...
    leftSidebar: {
        ...
        external_visibility: "Let others into your haven",
        launch_public_space: "Visit public space",
        system_configuration: "Settings",
        identity_registry: "Your account",
        system_ux: "Haven preferences",
        terminate_session: "Leave haven",
    ...
    editors: {
        ...
        effects: {
            ...
            atmosphere_title: "Haven atmosphere",
            active: "Selected",
        ...
        guestbook: {
            ...
            deploy: "Paste on mural",
            update: "Update Mural",
            visit_active: "People will be able to write in your haven.",
            tabs: {
