...
export const en: Dictionary = {
    ...
    landing: {
        studio_platform: "Creative Studio",
        curator_access_only: "Create your own mural",
        hero_title_curate: "A Home for",
        hero_title_your: "What",
        hero_title_reality: "You Feel.",
        hero_subtitle: "Create murals that match your rhythm. A place to keep music, photos, and memories in a composition made by you.",
        btn_create_studio: "Create my Mood",
        version_deployment: "Syncing blocks...",
        visuals: "01 — VIBE",
        audio: "02 — SOUNDTRACK",
        curation: "03 — MEMORY",
        showcase: {
            structure_title: "01 — YOUR PERSONAL SPACE",
            structure_desc: "A space of your own, free from noise. Organize your world in a layout that flows with you.",
            atmosphere_title: "02 — MUSIC & FEELING",
            atmosphere_desc: "Songs that understand your moment and moods that change with you. The atmosphere reflects your identity.",
            connection_title: "03 — REAL CONNECTIONS",
            connection_desc: "Receive messages and share your Studio with those who truly matter to you."
        },
        privacy: "Privacy",
        terms: "Terms",
        login_btn: "Login",
        ...
        claim_status_available: "Username available",
        claim_status_taken: "Username unavailable",
        claim_status_default: "Limited availability",
        essence_title: "A space for your",
        essence_title_italic: "digital moments",
        essence_subtitle: "Where your memories meet creativity. A place to give form to what you feel and keep what's important.",
        showcase_label: "Studio Tools",
        showcase_main_title: "Your world in",
        showcase_main_title_italic: "blocks",
        showcase_main_desc: "Drag and combine elements that define your style. From soundtracks to your favorite photos.",
        showcase_music_title: "Music & Videos",
        showcase_music_desc: "Spotify, YouTube Videos, and your own Audio.",
        showcase_stickers_title: "Drawings & Stickers",
        showcase_stickers_desc: "Doodles, art, and free visual elements.",
        showcase_connections_title: "Social & Links",
        showcase_typography_title: "Text & Notes",
        templates_label: "Ready Studios",
        templates_title: "Start with",
        templates_title_italic: "inspiration",
        templates_desc: "Don't want to start from scratch? Choose a base template and customize the space to your liking in seconds.",
        essence_feature_1_label: "",
        essence_feature_1_title: "Design without limits",
        essence_feature_1_desc: "Create murals that reflect your state of mind. No rigid grids, just the flow of your creativity.",
        essence_feature_2_label: "",
        essence_feature_2_title: "Immersive Environment",
        essence_feature_2_desc: "Sync sounds and visuals to create unique environments. Where every detail has a purpose.",
        essence_feature_3_label: "",
        essence_feature_3_title: "Your place in the world",
        essence_feature_3_desc: "Your space is your personal manifesto. A place that remains and resists the noise of social media.",
        footer_cta_title_1: "Ready to",
        footer_cta_title_2: "tune your",
        footer_cta_title_3: "reality?",
        footer_col_platform: "Platform",
        footer_link_studio: "The Studio",
        footer_link_global_wall: "Global Wall",
        ...
        showcase_module_quote: "Quotes & Inspiration",
        showcase_quote_text: "\"The architecture of silence is made of memories we insist on keeping.\"",
        showcase_quote_author: "— MoodSpace Manifesto",
        showcase_module_typography: "Minimalist Typography",
        ...
        showcase_quote_1_text: "Silence is the frame for all feelings and the space where the soul breathes.",
        showcase_quote_1_author: "Clarice Lispector",
        showcase_quote_2_text: "Reality is just a frame for what we imagine.",
        showcase_quote_2_author: "Fernando Pessoa",
        templates_tab_1_name: "Bio Links",
        templates_tab_1_cat: "Linktree Style",
        templates_tab_2_name: "Curated Playlist",
        templates_tab_2_cat: "Music & Videos",
        templates_tab_3_name: "Quotes & Notes",
        templates_tab_3_cat: "Editorial",
        templates_tab_4_name: "Doodles & Sketches",
        templates_tab_4_cat: "Sketchbook",
        templates_tab_5_name: "Photos & Gifs",
        templates_tab_5_cat: "Memories",
        showcase_label_bio: "Online Identity",
