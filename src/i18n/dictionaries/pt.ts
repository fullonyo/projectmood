...
export const pt = {
    ...
    sidebar: {
        ...
        media: {
            atmosphere_nodes_title: "Elementos",
        ...
        library: {
            ...
            items: {
                text: { title: "Textos", desc: "Escreva pensamentos livres" },
                photo: { title: "Imagens", desc: "Cole imagens e fotos estáticas" },
                youtube: { title: "Fita de Vídeo", desc: "Embed YouTube" },
                spotify: { title: "Disco de Vinil", desc: "Música do Spotify" },
                doodle: { title: "Desenho", desc: "Desenho à mão livre" },
                phrase: { title: "Letreiro", desc: "Texto em movimento" },
                quote: { title: "Citação", desc: "Destaque frases marcantes" },
                typography: { title: "Textos", desc: "Notas, Letreiros, Citações e Status" },
                countdown: { title: "Contador", desc: "Marque uma data" },
                guestbook: { title: "Recados", desc: "Deixe os outros assinarem" },
                moodStatus: { title: "Estado Atual", desc: "Como você está agora?" },
                social: { title: "Links", desc: "Links e redes sociais" },
                gif: { title: "Gifs", desc: "Reações e loops" },
                weather: { title: "Clima", desc: "Como está o dia lá fora?" },
                universal_media: { title: "Mídias", desc: "YouTube, Spotify & Áudio" },
                media: { title: "Mídias", desc: "YouTube, Spotify & Áudio" },
    ...
    landing: {
        ...
        showcase: {
            ...
            connection_desc: "Receba abraços em forma de mensagens e compartilhe seu estilo com quem importa. Onde a conexão é real e carinhosa."
        },
        privacy: "Privacidade",
        terms: "Termos",
        login_btn: "Entrar"
    ...
    auth: {
        ...
        register: {
            ...
            title: "Criar meu",
            title_italic: "Mood",
            unique_identifier: "Nome de usuário",
            placeholder_username: "seu_nome",
            communication_node: "Seu Email",
            placeholder_email: "seu@email.com",
            private_key: "Sua senha",
            placeholder_password: "••••••••",
            register_identity: "Começar minha jornada",
            already_registered: "Já tem seu lugar?",
            resume_session: "Entrar agora",
            identity_rejected: "Não foi possível criar sua conta. Tente outro usuário ou e-mail.",
            identity_established: "Conta criada com sucesso. Entrando...",
            cancel: "Voltar",
            footer: "Registro — MoodSpace",
            establishing: "Preparando tudo...",
        },
        banned: {
            title: "Acesso Restrito",
            message: "Esta conta foi suspensa por violar os Termos de Uso da plataforma. O acesso ao seu quarto digital e ao Studio foram revogados.",
        ...
        promotion: {
            ...
            viewing_status: "Explorando o espaço de",
            official_registry: "Visita",
            dismiss: "[ Esconder ]"
        }
    },
    leftSidebar: {
        ...
        system_node: "Seu mural",
        active_studio: "Mood aberto",
        identity_protocol: "Você",
        access_level: "Seu plano",
        studio_free: "Livre",
        system_status: "Status",
        authorized: "Acomodado",
        deployment_area: "Compartilhar link",
        ...
        terminate_session: "Sair",
        exit_hex: "Trancar a porta",
        command_center: "Studio",
        identity_tab: "Identidade",
    ...
    editors: {
        ...
        text: {
            title: "Mood de Texto",
            add_title: "Escrever algo",
            edit_title: "Editar Nota",
            subtitle: "Transforme seus sentimentos em palavras.",
            ...
            author_placeholder: "Quem disse isso?",
            styles: {
                simple: "Simples",
                postit: "Post-it",
                ripped: "Rasgado",
        ...
        photo: {
            ...
            subtitle: "Dê vida às suas memórias visuais.",
            ...
            alt_text: "Texto Alt (Acessibilidade)",
            alt_placeholder: "Descreva a imagem para quem não pode ver...",
            filter: "Filtro da Foto",
            geometry: "Moldura",
            deploy: "Pendurar foto",
            error_load: "Erro ao carregar a imagem. Verifique o link.",
            error_process: "Não foi possível processar esta imagem."
        },
        phrase: {
        ...
        social: {
            ...
            nodes: "O que é este link?",
            link_protocol: "Endereço do link",
    ...
    canvas: {
        ...
        layers_subtitle: "Organize a hierarquia do seu espaço",
        layers_status: "Status do Mural",
        layers_status_active: "Ativo",
        layers_synced: "Sincronizado",
        layers_safe: "Ambiente Seguro",
        layers_normalize: "Normalizar Camadas",
        layers_normalized: "Camadas Normalizadas",
        distance_label: "Distância",
        align_label: "Alinhamento",
        focusing_layer: "Sintonizando Camada",
    },

    block_manager: {
        empty: "Nenhum elemento no mural",
        labels: {
            text: "Texto",
            photo: "Foto",
            gif: "GIF Animado",
            ...
            rorschach: "Mancha Rorschach",
            quote: "Citação",
            moodStatus: "Status do Mood",
            "mood-status": "Status do Mood",
            ticker: "Texto em Movimento",
            subtitle: "Legenda Dinâmica",
            floating: "Texto Flutuante",
            tape: "Fita Adesiva"
        }
    },
    ...
    publish: {
        ...
        modal_title: "Finalizar Publicação",
        modal_description: "Dê um nome a esta versão ou deixe em branco. As alterações serão salvas no histórico e publicadas instantaneamente no seu endereço público.",
        label_placeholder: "Ex: Ajustes na Vibe, Update 1.0...",
        confirm_button: "Publicar Agora",
        ...
        restore_to_editor: "restaurar no editor",
        make_active: "tornar público",
        rollback_confirm_title: "reverter para esta versão?",
        rollback_confirm_message: "isso vai restaurar esta versão no seu editor e também na página pública. mudanças não publicadas serão perdidas.",
        restore_confirm_title: "restaurar rascunho?",
        restore_confirm_message: "isso trará esta versão para o seu editor do studio. sua página pública NÃO será alterada até que você publique.",
        rollback_success: "versão restaurada com sucesso",
        restore_success: "rascunho restaurado com sucesso",
        delete_version: "excluir versão",
        delete_confirm_title: "excluir permanentemente?",
        delete_confirm_message: "esta ação não pode ser desfeita. esta versão será removida do seu histórico.",
        delete_success: "versão excluída",
        version_history: "histórico",
        active_label: "ativo",
        no_versions: "sem versões",
    ...
    multiverse: {
        ...
        create_btn: "Criar Novo Espaço",
        modal_title: "Novo Espaço Mood",
        modal_message: "Crie um novo espaço no seu mural.",
        field_title: "Título do Espaço",
        field_title_placeholder: "Ex: Galeria de Fotos, Lab...",
        field_type: "Tipo de Espaço",
        type_permanent: "Permanente",
        type_temporary: "Temporário",
        core_identity: "Identidade Principal",
        pocket_dimensions: "Outros Espaços",
        protocol_label: "Tipo de Existência",
        protocol_eternal: "Eterno",
        protocol_ephemeral: "Efêmero",
        field_expiration: "Data de Expiração (Opcional)",
        field_max_views: "Limite de Acessos (Opcional)",
        field_max_views_placeholder: "Ilimitado",
        create_confirm: "Criar Espaço",
        create_success: "Novo portal aberto com sucesso!",
        create_error: "Falha ao criar espaço",
        collapsed_title: "Espaço Colapsado",
        collapsed_message: "Este espaço mood cumpriu seu ciclo de existência e retornou ao vazio primordial.",
        return_home: "Voltar para a Realidade",
        pocket_dimension: "Espaço Secundário",
        primary_space: "Meu Espaço",
        current_space_label: "Espaço Atual",
        editor_title: "Identidade do Espaço",
        field_slug: "Endereço (URL Slug)",
        field_slug_placeholder: "url-do-espaco",
        existence_protocol_desc: "O espaço será colapsado automaticamente nesta data.",
        view_limit_desc: "Fechar espaço após atingir este número de visualizações.",
        destroy_btn: "Destruir este Espaço Mood",
