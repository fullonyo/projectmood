...
export const pt = {
    ...
    publish: {
        ...
        rollback_confirm_message: "isso irá restaurar esta versão no seu editor e também na página pública. alterações não publicadas serão perdidas.",
        restore_confirm_title: "restaurar rascunho?",
        restore_confirm_message: "isso irá trazer esta versão para o seu editor de estúdio. sua página pública NÃO será alterada até que você publique.",
        ...
        delete_confirm_message: "esta ação não pode ser desfeita. esta versão do seu histórico será removida.",
