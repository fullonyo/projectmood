...
export const pt = {
    ...
    landing: {
        ...
        essence_title: "Um santuário para seus",
        essence_title_italic: "fragmentos digitais",
        essence_subtitle: "Onde a melancolia encontra a curadoria. Um espaço para dar forma ao que não se pode explicar, apenas sentir.",
        showcase_label: "Módulos do Estúdio",
        showcase_main_title: "Sua realidade em",
        showcase_main_title_italic: "blocos",
        showcase_main_desc: "Arraste, solte e combine elementos que definem seu estilo. Do som às conexões sociais.",
        showcase_music_title: "Multimídia Híbrida",
        showcase_music_desc: "Spotify, Embeds de YouTube e Mídias Locais.",
        showcase_stickers_title: "Figurinhas de Curadoria",
        showcase_stickers_desc: "Doodles e elementos visuais livres",
        showcase_connections_title: "Conexões Digitais",
        showcase_typography_title: "Manifesto & Tipografia",
        essence_feature_1_label: "01. Atemporalidade",
        essence_feature_1_title: "Arquitetura de Sentimentos",
        essence_feature_1_desc: "Construa interfaces que refletem seu estado de espírito. Sem grades rígidas, apenas o fluxo da sua criatividade.",
        essence_feature_2_label: "02. Ressonância",
        essence_feature_2_title: "Atmosfera Imersiva",
        essence_feature_2_desc: "Sincronize sons e visuais para criar ecossistemas que respiram. Onde cada pixel carrega uma intenção.",
        essence_feature_3_label: "03. Legado",
        essence_feature_3_title: "Ecos Digitais",
        essence_feature_3_desc: "Seu espaço é seu manifesto. Um rastro de curadoria que permanece, resistindo ao ruído efêmero da rede."
    },
    auth: {
        login: {
