...
export const pt = {
    ...
    landing: {
        studio_platform: "Studio Criativo",
        curator_access_only: "Crie seu próprio mural",
        hero_title_curate: "Um Lugar para os",
        hero_title_your: "Seus",
        hero_title_reality: "Sentimentos.",
        hero_subtitle: "Crie murais que acompanham seu ritmo. Um lugar para guardar músicas, fotos e lembranças em uma composição feita por você.",
        btn_create_studio: "Criar meu Mood",
        version_deployment: "Sincronizando blocos...",
        visuals: "01 — CLIMA",
        audio: "02 — TRILHA SONORA",
        curation: "03 — MEMÓRIA",
        showcase: {
            structure_title: "01 — SEU ESPAÇO PESSOAL",
            structure_desc: "Um ambiente só seu, livre de barulho. Organize seu mundo em um layout que flui com você.",
            atmosphere_title: "02 — MÚSICA & SENTIMENTO",
            atmosphere_desc: "Músicas que entendem seu momento e climas que mudam com você. A atmosfera reflete sua identidade.",
            connection_title: "03 — CONEXÕES REAIS",
            connection_desc: "Receba recados e compartilhe seu Studio com quem realmente importa para você."
        },
        privacy: "Privacidade",
        terms: "Termos",
        login_btn: "Entrar",
        claim_username_placeholder: "reservar seu @nome...",
        claim_username_btn: "Reservar",
        claim_status_available: "Username disponível",
        claim_status_taken: "Username indisponível",
        claim_status_default: "Disponibilidade limitada",
        essence_title: "Um espaço para seus",
        essence_title_italic: "momentos digitais",
        essence_subtitle: "Onde suas memórias encontram a criatividade. Um lugar para dar forma ao que você sente e guardar o que é importante.",
        showcase_label: "Ferramentas do Studio",
        showcase_main_title: "Seu mundo em",
        showcase_main_title_italic: "blocos",
        showcase_main_desc: "Arraste e combine elementos que definem seu estilo. Da trilha sonora às fotos preferidas.",
        showcase_music_title: "Música & Vídeos",
        showcase_music_desc: "Spotify, Vídeos do YouTube e seus próprios Áudios.",
        showcase_stickers_title: "Desenhos & Figurinhas",
        showcase_stickers_desc: "Doodles, artes e elementos visuais livres.",
        showcase_connections_title: "Redes & Links",
        showcase_typography_title: "Textos & Notas",
        templates_label: "Estúdios Prontos",
        templates_title: "Comece com",
        templates_title_italic: "inspiração",
        templates_desc: "Não quer começar do zero? Escolha um template base e customize o espaço com a sua cara em segundos.",
        essence_feature_1_label: "",
        essence_feature_1_title: "Design sem limites",
        essence_feature_1_desc: "Crie murais que refletem seu estado de espírito. Sem grades rígidas, apenas o fluxo da sua criatividade.",
        essence_feature_2_label: "",
        essence_feature_2_title: "Ambiente Imersivo",
        essence_feature_2_desc: "Sincronize sons e visuais para criar ambientes únicos. Onde cada detalhe tem um propósito.",
        essence_feature_3_label: "",
        essence_feature_3_title: "Seu lugar no mundo",
        essence_feature_3_desc: "Seu espaço é seu manifesto pessoal. Um lugar que permanece e resiste ao ruído das redes sociais.",
        footer_cta_title_1: "Pronto para",
        footer_cta_title_2: "sintonizar sua",
        footer_cta_title_3: "realidade?",
        footer_col_platform: "Plataforma",
        footer_link_studio: "O Estúdio",
        footer_link_global_wall: "Mural Global",
        footer_link_marketplace: "Marketplace",
        footer_col_ecosystem: "Ecossistema",
        footer_link_manifesto: "Manifesto",
        footer_link_community: "Comunidade",
        footer_link_labs: "Labs",
        ...
        showcase_module_quote: "Citações & Inspiração",
        showcase_quote_text: "\"A arquitetura do silêncio é feita de memórias que insistimos em guardar.\"",
        showcase_quote_author: "— Manifesto MoodSpace",
        showcase_module_typography: "Tipografia Minimalista",
        showcase_typography_text_1: "Curadoria da alma,",
        showcase_typography_text_2: "sincronia da realidade.",
        showcase_verified_space: "Espaço Verificado",
        showcase_quote_1_text: "O silêncio é a moldura de todos os sentimentos e o espaço onde a alma respira.",
        showcase_quote_1_author: "Clarice Lispector",
        showcase_quote_2_text: "A realidade é apenas uma moldura para o que imaginamos.",
        showcase_quote_2_author: "Fernando Pessoa",
        templates_tab_1_name: "Bio Links",
        templates_tab_1_cat: "Linktree Style",
        templates_tab_2_name: "Playlist Curada",
        templates_tab_2_cat: "Música & Vídeos",
        templates_tab_3_name: "Citações & Notas",
        templates_tab_3_cat: "Editorial",
        templates_tab_4_name: "Rabiscos & Sketches",
        templates_tab_4_cat: "Sketchbook",
        templates_tab_5_name: "Fotos & Gifs",
        templates_tab_5_cat: "Memórias",
        showcase_label_bio: "Identidade Online",
    ...
    editors: {
        ...
        theme: {
            ...
            y2k: "Frutiger Y2K",
            tarot: "Tarô Místico",
            node_luminance: "Atmosfera Cromática",
            luminance_desc: "Define o tom principal herdado por textos, redes sociais e partículas da sala.",
